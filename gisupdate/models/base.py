...
import re
import os
#A continuacion las librerias que no se utilizan en este proyecto
#import geojson
...
#####################################################
    ...
    def seleccionaPublicacion(self, tabla, codprov):
        ...
        #Se modifico la tabla de lectura agregandole el postfijo '_temp',
    ...
    def deltable(self, tablename):
        query = """DROP TABLE IF EXISTS %s_temp"""
        try:
